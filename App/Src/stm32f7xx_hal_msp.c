...
* @retval None
*/
void _HAL_DMA2D_MspInit(DMA2D_HandleTypeDef* hdma2d)
{
...
* @retval None
*/
void _HAL_DMA2D_MspDeInit(DMA2D_HandleTypeDef* hdma2d)
{
  if(hdma2d->Instance==DMA2D)
  {
...
* @retval None
*/
void _HAL_DSI_MspInit(DSI_HandleTypeDef* hdsi)
{
...
* @retval None
*/
void _HAL_DSI_MspDeInit(DSI_HandleTypeDef* hdsi)
{
  if(hdsi->Instance==DSI)
  {
...
* @retval None
*/
void _HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
...
* @retval None
*/
void _HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  if(hltdc->Instance==LTDC)
  {
...
static void _HAL_FMC_MspInit(void){
...
void _HAL_SDRAM_MspInit(SDRAM_HandleTypeDef* hsdram){
...
static void _HAL_FMC_MspDeInit(void){
...
void _HAL_SDRAM_MspDeInit(SDRAM_HandleTypeDef* hsdram){
