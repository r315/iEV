...
asset_root_path := $(ui_path)/generated
...
board_cpp_files += \
	...
	$(ui_path)/target/STM32F7HAL_DSI.cpp \
...
board_include_paths := \
	...
	$(ui_path)/target \
	$(ui_path)/platform/os \
	$(ui_path)/generated/fonts/include \
...
$(object_output_path)/%.o: %.cpp $(ui_mk)
	@echo Compiling $<
	@mkdir -p $(@D)
	@$(cpp_compiler) \
		-MMD -MP $(cpp_compiler_options) $(cpp_compiler_options_local) $(user_cflags) \
...
$(firstword $(dependency_files)): $(ui_mk)
...
$(asset_texts_output)/include/texts/TextKeysAndLanguages.hpp: $(text_database) $(ui_mk) $(textconvert_executable) $(fontconvert_executable) $(fontconvert_font_files)
